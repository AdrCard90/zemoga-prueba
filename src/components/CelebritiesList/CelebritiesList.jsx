                ...
                <div className="celebrity">
                  ...
                  <div className="celebrity__information">
                    ...
                    <div className="celebrity__content">
                      ...
                      <p className="celebrity__summary">
                        Vestibulum diam ante, porttitor a odio eget, rhoncus
                        neque. Aenean eu velit libero.
                      </p>
                      <div className="celebrity__votes">
                        <FontAwesomeIcon
                          className="celebrity__vote positive selected"
                          icon={faThumbsUp}
                        />
                        <FontAwesomeIcon
                ...
                <div className="celebrity">
                  ...
                  <div className="celebrity__information">
                    ...
                    <div className="celebrity__content">
                      ...
                      <div className="celebrity__votes">
                        <button className="celebrity__button">
                          Vote again
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="celebrity__information">
                    <div className="celebrity__header">
                      <FontAwesomeIcon
                        ...
                        icon={faThumbsUp}
                      />
                      <h1 className="celebrity__name">Malala Yousafzai</h1>
                    </div>
                    <div className="celebrity__content">
                      <p className="celebrity__publication">
                        <strong>1 month ago</strong> in Entertainment
